...
const userReducer = (state = initialUser, action) => {
  switch (action.type) {
    ...
    case "RESETPASSWORD_START":
      var new_state = _.assign({}, state, {
        waiting_for_server: false,
        reset_password: { is_executed: false }
      });
      return new_state;
    ...
    case "RESETPASSWORD_OK":
      var new_state = _.assign({}, state, {
        waiting_for_server: false,
        reset_password: { is_executed: true, is_error: false }
      });
      return new_state;
    ...
    case "CHANGEPASSWORD_START":
      var new_state = _.assign({}, state, {
        waiting_for_server: false,
        forgot_password: { is_executed: false }
      });
      return new_state;
    ...
    case "CHANGEPASSWORD_OK":
      var new_state = _.assign({}, state, {
        waiting_for_server: false,
        forgot_password: { is_executed: true, is_error: false }
      });
      return new_state;
    ...
    case "CREATE_INVOICE":
      new_state = _.assign({}, state, { page: "create_invoice" });
      return new_state;
    ...
    case "GET_TRACKINGPAGE_ORDER":
      var new_state = _.assign({}, state, {
        tracking_page_order: action.payload
      });
      return new_state;
      break;
...
const tsReducer = (state = [], action) => {
  switch (action.type) {
    ...
    case "REMOVE_TS":
      var todos = state.slice();
      _.remove(todos, function(currentTS) {
        return currentTS.task == action.payload.task;
      });
