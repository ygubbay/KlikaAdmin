...
import { logout, createInvoiceClick } from "../actions/userActions";
      ...
      <div className="orders-header">
        ...
        <div>
          <ButtonGroup justified>
            <NavLink className="btn btn-default" to="/orders">
              Orders
            </NavLink>
            <NavLink className="btn btn-default" to="/tracking">
              Delivery Tracking
            </NavLink>
            <NavLink className="btn btn-default" to="/dailyjobs">
              Daily Jobs
            </NavLink>
            ...
            <DropdownButton title="Admin" id="bg-justified-dropdown">
              ...
              <li role="presentation">
                <NavLink to="/login" onClick={this.onLogoutClick.bind(this)}>
                  Logout
                </NavLink>
              </li>
            </DropdownButton>
